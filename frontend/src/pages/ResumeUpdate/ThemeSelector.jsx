...
import {DUMMY_RESUME_DATA,themeColorPalette,resumeTemplates} from "../../utils/data";
...
const ThemeSelector = ({selectedTheme, setSelectedTheme,resumeData, onClose}) => {
  ...
  return (
    <div className="container p-4 mx-auto md:px-0">
        ...
        <div className="grid grid-cols-12 gap-5">
            <div className="col-span-12 bg-white md:col-span-5 ">
            ...
            <div className="col-span-12 -mt-3 bg-white md:col-span-7" ref={resumeRef}>
                <RenderResume
...
const ColorPalette = ({colors, isSelected, onSelect}) => {
    return (
        <div
            className={`flex h-28 bg-purple-50 rounded-lg overflow-hidden border-2 ${isSelected ? 'border-purple-500' : 'border-none '}`}
        >
