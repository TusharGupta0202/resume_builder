...
import { LuMail, LuMapPinHouse, LuPhone, LuUser, LuRss, LuGithub} from "react-icons/lu";
            ...
            <div className="flex items-start gap-5 mb-5">
                ...
                >
                    {resumeData.profileInfo.profilePreviewUrl ? (
                        ...
                        <div className="w-[140px] h-[140px] rounded-full flex items-center justify-center text-5xl " style={{color : themeColors[4]}}>
                            <LuUser />
                        </div>
                    )}
                </div>
                ...
                <div>
                    <div className="grid items-center grid-cols-12 gap-2">
                        ...
                        <div className="flex flex-col col-span-6 gap-5 mt-2">
                            <ContactInfo
                                icon={<LuMail />}
                                iconBg={themeColors[2]}
